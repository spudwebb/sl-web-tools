import{_ as e,n as o,e as t,s as n,x as s}from"./vendor-38224743.js";let a=class extends n{async openFlasherDialog(){import("./flashing-dialog-b16d4d4f.js");const e=await fetch(this.manifest),o=await e.json(),t=document.createElement("flashing-dialog");t.manifest=o,document.body.appendChild(t)}render(){const e="serial"in navigator;return s`
