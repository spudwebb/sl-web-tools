...
function parseRequirementsTxt(requirementsTxt) {
    ...
    if (requirementsTxt.startsWith('data:text/plain;base64,')) {
        requirementsTxt = atob(requirementsTxt.substring('data:text/plain;base64,'.length));
    }
...
export async function setupPyodide(onStateChange) {
    ...
    const wheelPath = './universal_silabs_flasher-0.1.2.post1+git.15b31dca-py3-none-any.whl';
